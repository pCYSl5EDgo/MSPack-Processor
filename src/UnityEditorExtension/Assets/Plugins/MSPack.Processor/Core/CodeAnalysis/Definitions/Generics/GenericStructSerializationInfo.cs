    ...
    public readonly struct GenericStructSerializationInfo : ITypeSerializationInfo
    {
...
#if CSHARP_8_0_OR_NEWER
        public GenericStructSerializationInfo(TypeDefinition definition, TypeReference formatterType, CustomAttributeArgument[] constructorArguments, MethodDefinition? serializationConstructorDefinition)
#else
        public GenericStructSerializationInfo(TypeDefinition definition, TypeReference formatterType, CustomAttributeArgument[] constructorArguments, MethodDefinition serializationConstructorDefinition)
#endif
        {
        ...
        public static bool TryParse(TypeDefinition type, bool useMapMode, out GenericStructSerializationInfo info)
        {
            ...
            else
            {
                ...
                info = new GenericStructSerializationInfo(type, formatterType, argumentArray, serializationConstructor);
            }
