...
{
    public sealed class UnionInterfaceFormatterImplementor
    {
        ...
        #region Deserialize
        private MethodDefinition GenerateDeserialize(in UnionInterfaceSerializationInfo info)
        {
        ...
        private (Instruction[][] switchInstrcutions, Instruction[] defaultInstructions, Instruction[] switchTable) GenerateSwitchStatements(in UnionInterfaceSerializationInfo info, VariableDefinition targetVariable)
        {
        ...
        #region Serialize
        private MethodDefinition GenerateSerialize(in UnionInterfaceSerializationInfo info, MethodDefinition get)
        {
        ...
        private (Instruction[][], Instruction[]) GenerateSerializeSwitchTable(in UnionInterfaceSerializationInfo info)
        {
