...
{
    public static class 残余長さが8であると確定したSpanに対する操作Helper
    {
    ...
    public static class 残余長さが7であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
    ...
    public static class 残余長さが6であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
    ...
    public static class 残余長さが5であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
    ...
    public static class 残余長さが4であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
    ...
    public static class 残余長さが3であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
    ...
    public static class 残余長さが2であると確定したSpanに対する操作Helper
    {
        public static (Instruction[], Instruction[]) Embed<TSorter>(BinaryFieldDestinationTuple[] tuples, int tuplesOffset, int tuplesCount, in AutomataOption options, TSorter sorter)
            where TSorter : ILengthSorter, IComparer<BinaryFieldDestinationTuple>
        {
