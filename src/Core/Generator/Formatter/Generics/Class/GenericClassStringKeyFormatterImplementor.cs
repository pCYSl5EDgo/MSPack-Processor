...
namespace MSPack.Processor.Core.Formatter
{
    public sealed class GenericClassStringKeyFormatterImplementor
    {
        ...
        #region Deserialize
        private MethodDefinition GenerateDeserialize(in GenericClassSerializationInfo info, in bool shouldCallback, MethodReference getIndexStaticMethod, GenericInstanceType targetGenericInstanceType)
        {
            ...
            var deserialize = new MethodDefinition(
                "Deserialize",
            ...
            Assignment(processor, in info, getIndexStaticMethod, targetGenericInstanceType);
        ...
        private void Assignment(ILProcessor processor, in GenericClassSerializationInfo info, MethodReference getIndexStaticMethod, GenericInstanceType targetGenericInstanceType)
        {
